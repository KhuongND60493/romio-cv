export default [
  {
    ...
    "note": "Kế hoạch theo học chương trình Thạc sĩ chuyên ngành Công nghệ Thông tin. Mục tiêu học tập sẽ tập trung chuyên sâu vào các thuật toán nâng cao, hệ thống phân tán và đặc biệt là xử lý dữ liệu lớn (Big Data) nhằm thiết kế và tối ưu hóa các kiến trúc dữ liệu quy mô doanh nghiệp.",
    "logoUrl": "uit.jpg"
  },
  {
