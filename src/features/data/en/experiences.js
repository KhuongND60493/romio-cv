export default [
  {
    ...
    "summary": "Leading a cross-functional team to architect and scale a hybrid (On-premise & Cloud Microservices) enterprise management ecosystem serving major F&B chains like Highland Coffee and Golden Gate.",
    "responsibilities": [
    ...
    "achievements": [
      ...
      "Designed reusable integration templates that reduced onboarding time for new enterprise partners.",
      "Strengthened observability with shared dashboards and operational runbooks, improving incident recovery speed.",
      "Led the migration of synchronous processing flows to event-driven pipelines with minimal business disruption."
    ],
    "techStack": [
      ".NET Core",
      "Java",
  ...
  },
  {
    ...
    "location": "Ho Chi Minh City",
    "summary": "Led technical architecture and R&D for the Go Food and Beverage ecosystem (GoF&B), directing and managing a large-scale technical department of >40 engineers.",
    "responsibilities": [
      ...
      "Managed a cross-functional team of >40 engineers to hit critical milestones and ensured high-quality, smooth releases.",
    ...
    "achievements": [
      ...
      "Improved release quality through technical review governance and cross-functional quality control.",
      "Raised engineering capability via mentoring, training sessions, and standardized development practices.",
      "Played a key role in stabilizing large releases for the GoF&B ecosystem."
    ],
    "techStack": [
      "Reactjs",
      "React-Native",
  ...
  },
  {
    ...
    "responsibilities": [
      ...
      "Designed and implemented fullstack solutions using .NET Core, and React/Vue."
    ],
    "achievements": [
      ...
      "Optimized query and data processing performance to keep systems stable under growing workloads.",
      "Standardized delivery architecture patterns across parallel client projects to improve team efficiency."
    ],
    "techStack": [
      ".NET Core",
      "Reactjs",
  ...
  },
  {
    ...
    "achievements": [
      ...
      "Contributed to modernizing legacy modules into a more maintainable and scalable technology stack.",
      "Delivered multiple core internal systems including HR, Groupware, and CRM Supply Chain modules.",
      "Maintained predictable delivery across projects with different team sizes and technical complexity."
    ],
    "techStack": [
      "Reactjs",
      "Vuex",
  ...
  },
  {
    ...
    "achievements": [
      "Successfully delivered the 'Learning Chinese for Japanese' mobile application within project timelines.",
      "Built a medical information app that improved appointment booking and medication reminder workflows.",
      "Collaborated effectively across cross-functional teams to ensure stable mobile releases."
    ],
    "techStack": [
      "Angular",
      "React-Native",
  ...
  },
  {
    ...
    "achievements": [
      "Led a 10-member team to launch the Riolish product for the English learning market.",
      "Delivered both admin web platform and companion mobile application for operational use.",
      "Supported iterative product improvements that expanded user adoption and service quality."
    ],
    "techStack": [
      "React-Native",
      ".NET Core",
  ...
  },
  {
    ...
    "responsibilities": [
      "Collaborator in programming the reading software."
    ],
    "achievements": [
      "Completed internship contributions successfully on Toshiba's reading application project.",
      "Contributed to core feature implementation of the reading software as part of the engineering team.",
      "Built a strong foundation in software delivery process and teamwork in an enterprise environment."
    ],
    "techStack": [
      "Word",
      "Excel",
  ...
  },
  {
    ...
    "responsibilities": [
      "Built an e-commerce website for computer and mobile products including purchase and admin pages."
    ],
    "achievements": [
      "Delivered a complete e-commerce website including customer purchase flow and admin management modules.",
      "Implemented business requirements for computer and mobile product sales workflows.",
      "Established early fullstack delivery experience through real production project execution."
    ],
    "techStack": [
      "ASP.NET MVC",
      "Microsoft SQL"
